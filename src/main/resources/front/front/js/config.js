...
var indexNav = [
    ...
    {
        name: '展品',
        url: './pages/zhanpin/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/lishiguancangxitong/admin/dist/index.html#/login";
