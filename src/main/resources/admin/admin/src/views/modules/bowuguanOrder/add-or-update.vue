    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="bowuguanOrderTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.bowuguanOrderTime"
                                type="date"
                                placeholder="预约时间"
                                :disabled="ro.bowuguanOrderTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.bowuguanOrderTime" label="预约时间" prop="bowuguanOrderTime">
                            <span v-html="ruleForm.bowuguanOrderTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="bowuguanOrderTypes">
                        <el-select v-model="ruleForm.bowuguanOrderTypes" :disabled="ro.bowuguanOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in bowuguanOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="bowuguanOrderValue">
                        <el-input v-model="ruleForm.bowuguanOrderValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    bowuguanId: false,
                    yonghuId: false,
                    bowuguanOrderTime: false,
                    buyNumber: false,
                    bowuguanOrderTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    bowuguanId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=bowuguan_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.bowuguanOrderTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`bowuguanOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.bowuguanOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
